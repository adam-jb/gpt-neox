...
if __name__ == '__main__':
	app.run(threaded=True, host='209.137.198.4', port=5000) # threaded=True mode allows concurrent requests, opening a new thread for each new request; but might block gunicorn
